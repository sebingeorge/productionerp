...
namespace ArabErp.Web.Controllers
{
    public class ProductionPlanController : Controller
    {
        ...
        public ActionResult ProductionOrderRelease()
        {
            return View();
        }
        public ActionResult PlanedOrder()
        {
            return View();
        }
        public ActionResult ConvertPlannedOrdertoPurReq()
        {
            return View();
        }
        ...
        public ActionResult PreviousCustomerOrder()
        {
            return View();
        }
        public ActionResult PendingCustomerOrder()
        {
            return View();
        }
